...
import { DemoDataService, UserStats } from '../../core/demo-data.service';
...
export class DuckdbUsersComponent implements OnInit {
  ...
  async saveUser(): Promise<void> {
    ...
    try {
      if (this.editingUser()) {
        this.demoData.updateUser(this.editingUser()!.id, this.formData());
        this.logger.info('User updated successfully');
      } else {
        this.demoData.createUser(this.formData());
