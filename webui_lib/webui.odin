...
get_url :: proc(win : Window) -> string { url_c := webui_get_url(win); if url_c == nil { return "" }; return cast(string) url_c }
...
event_get_string :: proc(e : ^Event) -> string { str_c := webui_get_string(e); if str_c == nil { return "" }; return cast(string) str_c }
event_get_string_at :: proc(e : ^Event, idx : c.size_t) -> string { str_c := webui_get_string_at(e, idx); if str_c == nil { return "" }; return cast(string) str_c }
...
encode :: proc(data : string) -> string { encoded_c := webui_encode(cast(cstring) data); if encoded_c == nil { return "" }; defer webui_free(cast(rawptr) encoded_c); return cast(string) encoded_c }
decode :: proc(data : string) -> string { decoded_c := webui_decode(cast(cstring) data); if decoded_c == nil { return "" }; defer webui_free(cast(rawptr) decoded_c); return cast(string) decoded_c }
